...
class AlbumController extends FrontController
{
    ...
    public function actionIndex()
    {
        $dataProvider = new SqlDataProvider([
            'sql' => 'SELECT id, cover_id, privilege_type, name FROM {{%blog_album}} WHERE created_by = :user_id',
    ...
    public function actionUpload($id)
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            // Yii::$app->db->createCommand()->insert('{{%blog_photo}}', [
            //     'name' => $origFileName,
            //     'path' => $fileName,
            //     'album_id' => $model->id,
            //     'created_at' => time(),
            ...
            // ])->execute();
            // \yii\imagine\Image::crop($_FILES['file']['tmp_name'], 160, 160)->save('uploads/blog/photo/' . $fileName, ['quality' => 80]);
        }
    ...
    protected function process($album_id)
    {
        ...
        $targetDir = 'uploads/blog/photo_tmp';
        $uploadDir = 'uploads/blog/photo';
