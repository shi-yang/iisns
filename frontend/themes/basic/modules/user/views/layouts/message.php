...
<div class="row">
    <div id="inbox-sidebar">
        ...
        <ul id="inbox-nav" class="nav nav-pills nav-stacked">
            <li><a href="<?= Url::toRoute(['/user/message/inbox']) ?>"><i class="glyphicon glyphicon-inbox"></i> <?= Yii::t('app', 'Inbox') ?> <span class="label label-danger"><?= Yii::$app->user->identity->unReadMessageCount ?></span></a>
            </li>
