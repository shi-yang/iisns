...
class Install {
	...
	private function validate() {
		...
		if( empty($this->settings['dbHost']) || empty($this->settings['dbUser']) || empty($this->settings['dbName']) || empty($this->settings['siteName']) || empty($this->settings['siteTitle']) || empty($this->settings['siteDescription'])) {
