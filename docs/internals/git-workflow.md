Git workflow for iiSNS contributors
===================================

So you want to contribute to iiSNS? Great! But to increase the chances of your changes being accepted quickly, please
...
The following steps will create a development environment for iiSNS, which you can use to work
on the core code of iiSNS framework. These steps only need to be done the first time you contribute.
...
**Now you have a working playground for hacking on iiSNS 2.**
