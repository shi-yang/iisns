iiSNS2 Core framework code style
==============================

The following code style is used for iiSNS 2.x core and official extensions development. If you want to pull-request code
...
You can get a config for CodeSniffer here: https://github.com/shi-yang/iisns-coding-standards
 ...
 * @copyright Copyright (c) 2008 iiSNS Software LLC
